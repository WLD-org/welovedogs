...
import { HeroPaws } from "@/components/landing/hero-paws";
    ...
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="container relative z-10 mx-auto px-4 pb-10 pt-8 md:pb-14 md:pt-12 lg:pb-16 lg:pt-14">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-2 font-sans text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
            <span
          ...
          <div
            className="animate-hero-enter -my-2 mb-6 flex justify-center motion-reduce:animate-none md:-my-4 md:mb-8"
          ...
          <p
            className="animate-hero-enter mx-auto mb-8 max-w-3xl text-pretty text-base leading-relaxed text-muted-foreground motion-reduce:animate-none sm:text-lg md:text-xl"
          ...
          <div
            className="animate-hero-enter mx-auto mb-8 grid max-w-3xl gap-3 sm:grid-cols-3 motion-reduce:animate-none"
          ...
          >
            {TRUST_STATS.map((stat) => {
              ...
              return (
                <div
                  key={stat.label}
                  className="rounded-xl border border-purple-100/80 bg-white/70 px-3 py-3 text-center backdrop-blur-sm"
                >
          ...
          <div
            className="animate-hero-enter flex flex-col gap-3 sm:flex-row sm:justify-center motion-reduce:animate-none"
